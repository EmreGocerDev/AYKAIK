        ...
        <div className="p-4 md:p-8 text-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-end mt-6">
                    <button onClick={handleSave} disabled={isSaving || loading || !selectedRegionId} className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors disabled:opacity-50 font-semibold">
                        <Save size={18} />
                        {isSaving ? 'Kaydediliyor...' : 'Bu Ayın Takvimini Kaydet'}
                    </button>
                </div>
            </div>
        </div>
